        ...
        child: Column(
          ...
          children: [
            ...
            ClassSelectionCard(
              ...
              classes: _classes,
              onClassChanged: (String? newValue) {
                setState(() {
            ...
            EnrollmentListHeader(
              showSelectAll: _paginatedStudents.isNotEmpty,
            ...
            EnrollmentStudentTable(
              ...
              onToggleEnrollment: _toggleStudentEnrollment,
            ),
            const SizedBox(height: 20),
            ...
            SaveEnrollmentsButton(
              onSave: _selectedClass == null || _selectedClass == 'All Classes'
                  ? null
                  : _saveEnrollments,
            ),
            const SizedBox(height: 20),
