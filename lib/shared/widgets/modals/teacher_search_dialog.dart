...
class TeacherSearchDialog extends StatefulWidget {
  ...
  final Function(Map<String, dynamic> teacher) onTeacherSelected;
  ...
  Future<void> searchTeacher() async {
    ...
    setState(() {
      ...
      if (result != null && result['status'] == true) {
        ...
        errorMessage = result?['message'] ?? "Teacher not found";
      }
    });
  }
            ...
            children: [
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: isSearching ? null : searchTeacher,
                  ...
                  child: Column(
                    children: [
                      CircleAvatar(
                        ...
                        child: Text(
                          (searchResult?['users']['full_name'] ?? "T")[0].toUpperCase(),
                          style: const TextStyle(
                            fontSize: 24,
                            color: Colors.white,
                      ...
                      Text(
                        searchResult?['users']['full_name'] ?? "N/A",
                        style: const TextStyle(
                          fontSize: 18,
                          fontWeight: FontWeight.w700,
                        ),
                      ...
                      Text(
                        searchResult?['users']['email'] ?? "",
                        style: TextStyle(
                          color: Colors.grey.shade700,
                        ),
                      ),
                      Text(
                        searchResult?['users']['phone'] ?? "",
                        style: TextStyle(
                          color: Colors.grey.shade700,
                        ),
                      ),
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            widget.onTeacherSelected(searchResult!);
