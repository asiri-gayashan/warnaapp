...
import 'package:warna_app/presentation/institute/controllers/institute_finance_controller.dart';
...
class _InstituteFinancePageState extends State<InstituteFinancePage> {
  late InstituteFinanceController _controller;
  ...
  void initState() {
    super.initState();
    _controller = InstituteFinanceController();
  ...
  Widget _buildClassCard(ClassFinanceModel cls) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              Expanded(child: _metricTile('Total Revenue', _rs(cls.revenue))),
              Expanded(child: _metricTile('Commission', _rs(cls.commission))),
            ],
          ),
          const SizedBox(height: 10),
          Row(
  ...
  Widget _teacherBadge(bool paid) {
  ...
  Widget _buildTeachersTab() {
    final paidCount = _controller.teachers.where((t) => t.paid).length;
    final pendingCount = _controller.teachers.where((t) => !t.paid).length;
    ...
    return Column(
      ...
      children: [
        ...
        ..._controller.teachers.map((t) => _buildTeacherItem(t)),
      ],
    );
  }

  Widget _buildTeacherItem(TeacherFinanceModel teacher) {
    final parts = teacher.tutorName.split(' ');
          ...
          Container(
            ...
            child: Text(
              ...
              style: TextStyle(
                fontSize: 14,
                fontWeight: FontWeight.w700,
                color: teacher.paid ? AppColors.primary : AppColors.warning,
              ),
            ),
          ),
          const SizedBox(width: 12),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 3),
                Text(
                  '${teacher.className} · Grade ${teacher.grade}',
                  style: TextStyle(
                    fontSize: 11,
                    color: AppColors.textSecondary,
                  ),
