...
class InstituteProfileModel {
  ...
  factory InstituteProfileModel.fromJson(Map<String, dynamic> j) {
...
class InstituteProfileController extends ChangeNotifier {
  ...
  void validateFullName(String value) {
    ...
    if (name.isEmpty) {
      ...
      _fullNameValid = false;
      fullNameError = 'Full name must not exceed 60 characters';
  ...
  void validatePhone(String value) {
    ...
    if (phone.isEmpty) {
      ...
      _phoneValid = false;
      phoneError = 'Phone number must start with 07';
  ...
  void _initValidation(InstituteProfileModel p) {
  ...
  Future<bool> fetchProfile() async {
    ...
    try {
      ...
      final results = await Future.wait([
        _dio.get('/institutes/profile/$userId'),
      ...
      if (data != null) {
        profile = InstituteProfileModel.fromJson(data as Map<String, dynamic>);
      ...
      debugPrint('Error fetching institute profile: $e');
  ...
  // ── Update profile ────────────────────────────────────────────
  Future<bool> updateProfile(InstituteProfileModel updated) async {
    isSaving = true;
    notifyListeners();

    try {
      await _dio.put(
        '/institutes/profile/${updated.id}',
        data: {
      ...
      debugPrint('Error updating institute profile: $e');
      isSaving = false;
      notifyListeners();
      return false;
    }
