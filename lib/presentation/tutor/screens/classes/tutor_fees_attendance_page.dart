...
class TutorFeesAttendancePage extends StatefulWidget {
  const TutorFeesAttendancePage({Key? key}) : super(key: key);

  @override
  State<TutorFeesAttendancePage> createState() =>
      _TutorFeesAttendancePageState();
}

class _TutorFeesAttendancePageState extends State<TutorFeesAttendancePage> {
                ...
                Expanded(
                  child: ElevatedButton(
                    onPressed: () {
                      ...
                      //   context,
                      //   MaterialPageRoute(
                      //     builder: (context) => const TutorMarkAttendancePage(),
                      //   ),
                      // );
                    },
                ...
                Expanded(
                  child: OutlinedButton(
                    onPressed: () {
                      ...
                      //   context,
                      //   MaterialPageRoute(
                      //     builder: (context) => const TutorMarkPaymentPage(),
                      //   ),
                      // );
                    },
