...
import 'package:warna_app/presentation/student/screens/institute/student_institute_detail_page.dart';
                ...
                child: ListView(
                  ...
                  children: [
                    ...
                    Wrap(
                      spacing: 8,
                      runSpacing: 8,
                      children: studentInstituteStatusOptions.map((status) {
...
class StudentInstitutesPage extends StatefulWidget {
  const StudentInstitutesPage({Key? key}) : super(key: key);

  @override
  State<StudentInstitutesPage> createState() => _StudentInstitutesPageState();
}
