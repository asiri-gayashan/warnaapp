...
import 'package:warna_app/presentation/student/controllers/student_institute_detail_controller.dart';
...
class StudentInstituteDetailPage extends StatefulWidget {
  final StudentInstituteModel institute;

  const StudentInstituteDetailPage({Key? key, required this.institute})
      : super(key: key);

  @override
  State<StudentInstituteDetailPage> createState() =>
      _StudentInstituteDetailPageState();
}

class _StudentInstituteDetailPageState
    extends State<StudentInstituteDetailPage> {
  late StudentInstituteDetailController _controller;

  @override
  void initState() {
    super.initState();
    _controller =
        StudentInstituteDetailController(institute: widget.institute);
            ...
            child: Column(
              ...
              children: [
                ...
                InfoTile(
                  ...
                  value: institute.addressLine1.isNotEmpty
                      ? '${institute.addressLine1}'
                          '${institute.addressLine2.isNotEmpty ? ', ${institute.addressLine2}' : ''}'
                      : 'N/A',
                ),
                ...
                InfoTile(
                  ...
                  label: 'My Classes',
                  value: '${institute.myClassCount} Classes',
                ),
