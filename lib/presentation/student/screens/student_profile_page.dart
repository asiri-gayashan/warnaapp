...
import 'package:warna_app/presentation/student/controllers/student_profile_controller.dart';
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      NewSelectOptions(
                        ...
                        onChanged: (id) {
                          setState(() => _gradeId = id);
                          _controller.setGrade(id);
                        },
                      ),
                      FieldErrorText(message: _controller.gradeError),
                      const SizedBox(height: 16),
                      ...
                      CustomTextField(
                        ...
                        onChanged: (v) => _controller.validateSchool(v),
                      ),
                      FieldErrorText(message: _controller.schoolError),
                      const SizedBox(height: 16),

                      CustomTextField(
                        label: 'Bio / Description',
                        hintText: 'Tell tutors a little about yourself...',
